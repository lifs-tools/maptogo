curl -X 'POST' \
  ...
  "term_representation": "greater",
  "unrecognizable_molecules": "molecule_handling_remove",
  "non_background_molecules": "molecule_handling_remove",
  "bounded_fatty_acyls": false
}'
